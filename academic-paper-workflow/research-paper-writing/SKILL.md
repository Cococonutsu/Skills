...
description: Content-level research paper writing coach for ML/CV/NLP manuscripts. Use for paper story, section logic, paragraph flow, claim-evidence alignment, Abstract/Introduction/Related Work/Method/Experiments/Conclusion drafting or rewriting, and reviewer-facing presentation when the task does not require source-aware LaTeX/Typst compilation, formatting, citation checks, or submission-gate review.
metadata:
  short-description: Paper story, section logic, and paragraph-level academic writing
---
